...
// let femaleCharacters = starWarsCharacters.filter(c => c.gender == 'female' );
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  // if(eyeColor[personaggioCorrente.eye_color])
  //   eyeColor[personaggioCorrente.eye_color].push(personaggioCorrente);
  ...
  switch (personaggioCorrente.eye_color) {
    ...
    default:
      ...
      //throw new Error('Colore non esistente')
  }
}

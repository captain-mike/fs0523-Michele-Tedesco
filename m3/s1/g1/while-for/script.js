...
for (let x = 0; x < 10; x++) {
    if (x == 5)
        continue; //salto all'iterazione successiva se la condizione è vera
    console.log(x);
}
let pizze = ['Margherita', 'Diavola', 'Capricciosa']; //length = 3
...
pizze.forEach((pizza) => console.log(pizza));
